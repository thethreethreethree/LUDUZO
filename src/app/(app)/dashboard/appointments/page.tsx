  ...
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-6 p-8">
      <div>
        ...
        <p className="text-sm text-zinc-500">Personal-training and 1:1 sessions.</p>
      </div>
        ...
        <form action={createAppointment} className="flex flex-col gap-3 rounded-md border border-onyx bg-onyx p-5">
          ...
          <div className="flex gap-3">
            ...
            <label className="flex min-w-0 flex-1 flex-col gap-1 text-sm">
              ...
              <select name="trainer_id" className="w-full rounded-md border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900">
                <option value="">— none —</option>
                {staff.map((s) => (
          ...
          <label className="flex flex-col gap-1 text-sm">
            ...
            <input name="title" placeholder="e.g. Strength assessment" className="w-full rounded-md border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900" />
          </label>
          <div className="flex gap-3">
            <label className="flex min-w-0 flex-1 flex-col gap-1 text-sm">
            ...
            <label className="flex min-w-0 flex-1 flex-col gap-1 text-sm">
              ...
              <input name="price" type="number" step="0.01" min="0" placeholder="0.00" className="w-full rounded-md border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900" />
            </label>
          </div>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-sm font-medium text-zinc-500">Upcoming &amp; recent</h2>
        {appts.length === 0 ? (
