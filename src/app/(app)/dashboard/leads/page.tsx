    ...
    <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-6 p-8">
      ...
      {orgs.length > 0 ? (
        <form action={createLead} className="flex flex-wrap items-end gap-3 rounded-md border border-onyx bg-onyx p-5">
          <OrgPicker orgs={orgs} />
          <input name="name" required placeholder="Name" className="min-w-0 flex-1 rounded-md border border-iron px-3 py-2 text-sm bg-onyx-2" />
          ...
          <input name="phone" placeholder="Phone" className="w-32 rounded-md border border-iron px-3 py-2 text-sm bg-onyx-2" />
          <input name="source" placeholder="Source" className="w-28 rounded-md border border-iron px-3 py-2 text-sm bg-onyx-2" />
